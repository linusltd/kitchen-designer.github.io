...
class CashPaymentVoucherController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.accounts.cashpaymentvoucher.index', get_defined_vars());
    }
    ...
    {
        /*Creating Voucher*/
        $voucher = Voucher::create(['amount' => $request->amount, 'type' => 1]);
        /*Updating Voucher ID*/
        ...
        foreach ($request->account_ids as $key => $account_id) {
            Transaction::create([
                ...
                'cr' => $request->amounts[$key]
            ]);
        }

        return response()->json(['success' => true, 'response' => 'Payment voucher created successfully!']);
    }
