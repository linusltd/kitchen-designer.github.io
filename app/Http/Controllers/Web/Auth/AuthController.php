...
class AuthController extends Controller
{
    ...
    {
        return view('new-website.auth.login.index', get_defined_vars());
    }
    ...
    {
        return view('new-website.auth.forgotpassword.index', get_defined_vars());
    }
    ...
    public function resetPassword($token)
    {
        ...
        return view('new-website.auth.resetpassword.index', get_defined_vars());
    }
