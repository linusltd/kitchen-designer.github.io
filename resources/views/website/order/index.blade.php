...
<header class="breadcrumb">
    <div class="container breadcrumb__container">
        ...
        <a href="" class="breadcrumb__link">Order Complete</a>
    </div>
</header>
<!-- /Breadcrumb Section -->
        ...
        <div class="order__wrapper">
            <div class="order__info-wrapper">
                ...
                <div class="custom__info">
                    ...
                    <div class="info__body">
                        ...
                        <div class="custom__contact">
                            ...
                            <p class="custom__contact-info">Cash on delivery (COD) - <strong class="deliver__charges">Rs.{{ number_format($order->total_amount )}}</strong></p>
                        </div>
                    </div>
                    <div class="info__body">
                        <div class="custom__contact">
                            <h3 class="custom__contact-title">Shipping Address</h3>
                            <p class="custom__contact-info">{{ $order->address->fname .' '. $order->address->lname }}</p>
                            <p class="custom__contact-info">{{ $order->address->address }}</p>
                            <p class="custom__contact-info">{{ $order->address->city .' '. $order->address->zip}}</p>
                ...
                <div class="need__help">
                    <p class="returning__customer">Need Help? <a href="{{ route('website.home.contact') }}">Contact Us</a></p>
                    <div>
                ...
                <table class="cart__table">
                    ...
                    <tbody class="cart__body">
                        ...
                        <tr>
                            <td>
                                <div class="cart__item">
                                    ...
                                    <a href="{{ route('website.home.book-detail-view', $item->book->slug) }}"><p class="cart__item-name">{{ $item->book->name }}</p></a>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td align="center" class="shipping__fee">Rs.{{ number_format($order->delivery_charges) }}</td>
                        </tr>
                        <tr>
                            <td class="total"><strong>TOTAL</strong></td>
                            <td></td>
                            <td align="center" class="total"><strong>Rs.{{ number_format($order->total_amount) }}</strong></td>
                        </tr>
                    </tbody>
                </table>
            </div>
