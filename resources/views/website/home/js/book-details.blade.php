        ...
        $(document).ready(function(){
            ...
            $('#submitReview').click(function(){
                ...
                if(!$.trim(name) || !$.trim(name) || !$.trim(ratings) || !$.trim(review)){
                    $('.reviewmessage').html(`<span style="color:red">Not all the fields have been filled out correctly!</span>`)
                }else{
                    $('.reviewmessage').html('');
                    ...
                    $.ajax({
                        ...
                        method:"POST",
                        data:{name, email, ratings, review, book_id, user_id, _token},
                        success:function(response){
                            $('.reviewmessage').html(`<span style="color:green">Your Review has been submited successfully!. it will list once verified!</span>`)
