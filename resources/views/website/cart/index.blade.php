                                ...
                                <td>
                                    <div class="cart__item">
                                        ...
                                        <div class="cart__item-info">
                                            <a href="{{ route('website.home.book-detail-view', $item->book->slug) }}"
                                                class="cart__item-name">{{ $item->book->name }}
                                            </a>
                                            <span class="cart__mobile_quantity">{{ $item->quantity }} x
                                                Rs.{{ $item->price }} = Rs.{{ $item->total_price }}</span>
                                            <i class="cart__mobile_trash fa fa-trash" style="cursor: pointer;color:red"
                                                id="deleteCartItem" data-id="{{ $item->id }}"></i>
                                        </div>
                                    </div>
                                </td>
                                <td>Rs.{{ $item->price }}</td>
                                <td>
                                    <div class="quick__qty">
                                        <div class="qty__wrapper">
                                            <button class="minus__btn" id="removeFromCartInternalBtn"
                                                data-id="{{ $item->id }}"><i class="fas fa-minus"></i></button>
                                            <input type="text" name="" id=""
                                                value="{{ $item->quantity }}" readonly>
                                            <button class="plus__btn" id="addToCartInternalBtn"
                                                data-id="{{ $item->book_id }}"><i class="fas fa-plus"></i></button>
                                        </div>
                                    </div>
                                </td>
                                <td>Rs.{{ $item->total_price }}</td>
                                <td><i class="fa fa-trash" style="cursor: pointer;color:red" id="deleteCartItem"
                    ...
                    <div class="cart__adress-wrapper">
                            ...
                            <div class="add__review-form">
                                <div class="form-group-inline">
                                    <div class="form-group">
                                        <label for="fname" class="lable">First Name <span
                                                style="color: red">*</span></label>
                                        <input type="text" name="fname" class="form-control"
                                            value="{{ !is_null($address) ? $address->fname : '' }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="lname" class="lable">Last Name <span
                                                style="color: red">*</span></label>
                                ...
                                <div class="form-group">
                                    <label for="address" class="lable">Address <span
                                            style="color: red">*</span></label>
                                    <input type="text" name="address" class="form-control"
                                        value="{{ !is_null($address) ? $address->address : '' }}">
                                </div>
                                <div class="form-group">
                                    <label for="city" class="lable">Town/City <span
                                            style="color: red">*</span></label>
                        ...
                        <div class="cart__ordersummary">
                            ...
                            <div class="form-group checkbox-group">
                                ...
                                <label for="" class="lable"><b>Cash on delivery</b> (Pay with cash upon
                                    delivery.)</label>
                            </div>
                            ...
                            <p style="color: #616161;font-size:12px">Your personal data will be used to process your order,
