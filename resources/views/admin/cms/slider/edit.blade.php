              ...
              <form method="POST"  enctype="multipart/form-data" onsubmit="return false">
                ...
                <div class="row mb-3">
                    <div class="col-6">
                        ...
                        <select name="type" class="form-control">
                            <option value="0" @selected($slider->type == 0)>Home</option>
                            <option value="1" @selected($slider->type == 1)>Shop</option>
                            <option value="2" @selected($slider->type == 2)>English</option>
                        ...
                        <div class="upload__img-wrap">
                            <div class="upload__img-box">
                                <div style='background-image: url("{{ asset('storage/' . $slider->image) }}")'
                                    class='img-bg'>
                                    <div class='upload__img-close' data-id="{{ $slider->id }}"></div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="">
                    ...
                    <div class="mobile_upload__box">
                        <div class="mobile_upload__img-wrap">
                            <div class="upload__img-box">
                                <div style='background-image: url("{{ asset('storage/' . $slider->mobile_image) }}")'
                                    class='img-bg'>
                                    <div class='mobile_upload__img-close' data-id="{{ $slider->id }}"></div>
                                </div>
                            </div>
                        </div>
                        <div class="mobile_upload__btn-box">
                ...
                <div class="row mb-3">
                    <div class="col-6 mb-3">
                        ...
                        <input type="text" name="color" id="color" placeholder="#ccc" value="{{ $slider->color }}" class="form-control">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-3">
                        <div class="form-check">
                            <input name="redirect" class="form-check-input" type="radio" value="0" id="category" @checked($slider->redirect === 0)/>
                            <label class="form-check-label" style="cursor: pointer" for="category"> Redirect To a Book Detail Page </label>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-check">
                            <input name="redirect" class="form-check-input" type="radio" value="1" id="book" @checked($slider->redirect === 1)/>
                            <label class="form-check-label" style="cursor: pointer" for="book"> Redirect To a Category Page </label>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-check">
                            <input name="redirect" class="form-check-input" type="radio" value="2" id="url" @checked($slider->redirect === 2)/>
                ...
                <div class="row mb-3 d-none" id="urlDiv">
                    <div class="col-6 mb-3">
                        ...
                        <input type="text" name="url" id="url" value="{{ $slider->url }}" placeholder="e.g /shop" class="form-control">
                      </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-1">
                        <div class="form-check">
                            <input name="status" class="form-check-input" type="radio" value="0" id="active" @checked($slider->status == 0)>
                            <label class="form-check-label" style="cursor: pointer" for="active"> Active </label>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-check">
                            <input name="status" class="form-check-input" type="radio" value="1" id="inactive" @checked($slider->status == 1)/>
...
@include('admin.cms.slider.js.edit')
@endsection
