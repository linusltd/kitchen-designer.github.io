...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4 text-center"><i class="fas fa-money text-success"></i> CASH RECEIPT VOUCHER</h4>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <form action="{{ route('admin.cash-receipt-voucher.store') }}" method="POST"
        ...
        @include('admin.accounts.cashreceiptvoucher.js.index')
    @endsection
